...
<head>
    ...
    <style>
        ...
        .delete { background-color: #ff9800; color: #fff; }
...
<div class="main-content">
    ...
    <select id="entriesSelect">
        ...
        <div class="right-controls">
            ...
            <button class="btn btn-success" onclick="openModal()">+ Add House</button>
        </div>
    </div>
            ...
            <?php while($row = mysqli_fetch_assoc($houses)): ?>
                <tr data-id="<?= $row['house_id'] ?>">
                    ...
                    <td class="action-btns">
                        <button class="btn btn-primary btn-sm" onclick='editHouse(<?= json_encode($row) ?>)'>Update</button>
                        <button class="btn btn-danger btn-sm" onclick='deleteHouse("<?= $row["house_id"] ?>")'> Delete</button>
                    </td>
                </tr>
            <?php endwhile; ?>
        </tbody>
