...
// Current page detection for sidebar active highlighting (consistency with other admin pages)
...
<head>
    ...
    <link rel="stylesheet" href="../css/ictdashboard.css">    <link rel="stylesheet" href="../css/global.css">    <style>
        ...
        .close-btn { background: #ff9800; color: #fff; border: none; padding: 5px 10px; border-radius: 5px; cursor: pointer; }
...
<div class="sidebar" id="sidebar">
    ...
    <nav>
        <ul>
            <li><a href="ictdashboard.php" class="<?= $current === 'ictdashboard.php' ? 'active' : '' ?>">User Management</a></li>
            <li><a href="ictdashboard.php?log_type=houses" class="<?= $logType === 'houses' ? 'active' : '' ?>">Houses Logs</a></li>
            <li><a href="ictdashboard.php?log_type=bills" class="<?= $logType === 'bills' ? 'active' : '' ?>">Bills Logs</a></li>
        </ul>
    </nav>
</div>
