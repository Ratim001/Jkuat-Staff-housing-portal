...
// Current page detection for sidebar active highlighting
...
<head>
    ...
    <style>
        ...
        .main-content { margin-left: 220px; padding: 20px 30px; min-height: 100vh; background-color: #fff; }
...
<div class="sidebar" id="sidebar">
    ...
    <nav>
        <ul>
            ...
            <li><a href="manage_applicants.php" class="<?= $current === 'manage_applicants.php' ? 'active' : '' ?>">Manage Applicants</a></li>
    ...
    <div class="section active" id="applicantsSection">
        ...
        <?php endif; ?>
            <?php if (!empty($_SESSION['flash_error'])): ?>
                <div style="background:#e3f2fd;border:1px solid #bbdefb;padding:10px;margin-bottom:12px;border-radius:4px;color:#1a237e;">
        ...
        <div style="background: #f9f9f9; padding: 15px; border: 1px solid #ccc; margin-bottom: 20px; border-radius: 6px;">
            <form method="post">
                ...
                <button type="submit" name="send_notification" class="btn btn-success">Send to All</button>
            </form>
        </div>
        ...
        <table>
            ...
            <?php while ($row = mysqli_fetch_assoc($applicants)) {
                ...
                switch (strtolower($displayStatus)) {
                    ...
                    case 'rejected': $statusColor = '#ff9800'; break;
                    case 'cancelled': $statusColor = 'gray'; break;
                    case 'tenant': $statusColor = 'green'; break;
                    case 'applied': $statusColor = '#ff9800'; break;
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <button type="button" class="btn btn-info btn-sm" onclick="toggleForm('form<?= $row['applicant_id'] ?>')">Notify</button>
                            ...
                            <td>
                                <?php
                                    ...
                                    if ($cur === 'applied') {
                                        ...
                                        <button type="button" class="btn btn-primary btn-sm" data-app-id="<?= htmlspecialchars($app['application_id']) ?>" disabled>Save</button>
                                        <?php
                                    } else {
                                        ...
                                        $color = 'gray';
                                        if ($norm === 'applied') $color = '#ff9800';
                                        elseif ($norm === 'pending') $color = 'orange';
                                        elseif ($norm === 'won') $color = 'green';
                                        elseif ($norm === 'not successful' || $norm === 'unsuccessful') $color = '#ff9800';
    ...
    <div class="section" id="ballotsSection">
        ...
        <form id="ballotControlsForm" method="POST" style="margin-top:14px; display:flex; gap:10px; flex-wrap:wrap; align-items:center;">
            ...
            <div style="display:flex;gap:8px;align-items:center;">
                ...
                <div style="display:flex;gap:8px;align-items:center;">
                <button class="btn btn-primary" name="start_ballot_custom" title="Start ballot with the specified end date or duration">Start Balloting</button>
                        ...
                        <td>
                            <?php if ($r['status'] === 'pending') { ?>
                                <form method="post" style="display:inline-block;">
                                    ...
                                    <button class="btn btn-success btn-sm" name="admin_forfeit_action" value="approve">Approve</button>
                                </form>
        ...
        <form method="POST">
            <div style="display:flex;gap:12px;align-items:flex-end;flex-wrap:wrap;">
                ...
                <div style="align-self:end;">
                    <button class="btn btn-primary" name="manual_allocate">Allocate</button>
                </div>
            </div>
        </form>
    </div>
